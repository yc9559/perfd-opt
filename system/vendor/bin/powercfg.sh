...
apply_common()
{
    ...
    mutate "0" /proc/sys/kernel/sched_walt_rotate_big_tasks
    ...
    # default value
    lock_val "0" /sys/devices/system/cpu/cpu0/sched_load_boost
}
...
apply_powersave()
{
    ...
    # target_load ~90
    lock_val "-12" /sys/devices/system/cpu/cpu0/sched_load_boost
}
...
echo "Version:  20190721"                                   >> ${panel_path}
echo ""                                                     >> ${panel_path}
